    ...
    public partial class houses : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserStarreds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserStarreds_Houses_HouseId",
                        column: x => x.HouseId,
                        principalTable: "Houses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserStarreds_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserStarreds_HouseId",
                table: "UserStarreds",
                column: "HouseId");

            migrationBuilder.CreateIndex(
                name: "IX_UserStarreds_UserId",
                table: "UserStarreds",
                column: "UserId");
        }
